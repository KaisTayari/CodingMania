							...
							<div class="row">
								<div class="col-md-6">
									<div class="left-side-form">
										...
										<h5>
										  <label for="contact">Contact</label><span class="error">
												<?php print $econtact; ?></span></h5>
										<p><input type="text" name="contact" value="<?php print $contact; ?>"></p>

										<h5><label for="email">E-mail</label><span class="error">
								...
								<div class="col-md-6">
									<div class="right-side-form">
										<h5><label for="class">Motivation</label><span class="error">
												<?php print $eclass; ?></span></h5>
										<p><input type="text" name="class" value="<?php print $class; ?>"></p>

										<h5>
										  <label for="shift">Shift</label></h5>
										...
										<h5><label for="blgroup">Feedback</label><span class="error">
												<?php print $eblgroup; ?></span></h5>

										<p><input type="text" name="blgroup" value="<?php print $blgroup; ?>"></p>

										<h5><label for="division">Field of Study</label></h5>
